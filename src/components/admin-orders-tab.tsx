...
export function AdminOrdersTab() {
  ...
  const exportExcelFn = useServerFn(exportOrdersExcel);
  ...
  const handleExportCSV = async () => {
    ...
    try {
      ...
      toast.success(
        locale === "ar"
          ? "تم تصدير سجل الطلبات بتنسيق Excel الرسمي مع تفاصيل المتغيرات"
          : "Orders exported successfully in official Excel format",
      );
    } catch (err: unknown) {

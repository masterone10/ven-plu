...
import { AdminVariantMatrix } from "@/components/admin-variant-matrix";
                        ...
                        <td className="p-3">
                          <div className="flex items-center gap-3">
                            <Link
                              to="/products/$slug"
                              params={{ slug: p.slug }}
                              className="size-10 rounded-lg overflow-hidden bg-muted/40 border border-border shrink-0 flex items-center justify-center hover:opacity-80 transition"
                            >
                              {p.imageUrl ? (
                            ...
                            <div>
                              <Link
                                to="/products/$slug"
                                params={{ slug: p.slug }}
                                className="font-bold text-foreground block hover:text-primary transition hover:underline"
                              >
                        ...
                        <td className="p-3 text-end">
                          <div className="flex items-center justify-end gap-1">
                            <Button
                              ...
                              variant="ghost"
                              size="icon"
                              title={locale === "ar" ? "معاينة صفحة المنتج" : "View Product"}
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        {isLoading ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6 pt-2">
            ...
            {/* Variants Matrix (Color x Size x Stock) */}
            <div className="space-y-3">
              <AdminVariantMatrix
                variants={form.variants}
                baseSku={form.slug || "PROD"}
                baseCashPrice={form.cashPrice}
                pointsEnabled={form.pointsEnabled}
                defaultPointsPrice={form.defaultPointsPrice}

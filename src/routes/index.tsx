...
function HomePage() {
  ...
  const steps = [
    {
      icon: PackageCheck,
      ar: "مرونة في الدفع والشحن",
      en: "Flexible payment & shipping",
      arBody:
        "ادفع للمنتجات أو للشحن بالكاش أو بالنقاط بحرية وفق اختيارك مع دعم الخلط المنظم (كاش/نقاط).",
      enBody:
        "Pay for products or shipping with cash or points independently according to your choice.",
    },
    {
      icon: Coins,
